  ...
  return (
    <View style={styles.container}>
      <ScrollView>
        ...
        <Text style={{color: '#07354B', marginBottom: 20, fontSize: 13}}>
          Due: 10 Jun
        </Text>
        <Text
          style={{
        ...
        <Text style={{color: '#07354B', marginBottom: 20, fontSize: 13}}>
          Political Behavior: Investigates individual and collective political
          actions, including voting behavior, political participation, social
          movements, public opinion, and political communication.
        </Text>
        <Text style={{color: '#AE2327', marginBottom: 20, fontSize: 15}}>
          Attachments
        </Text>
        ...
        <View style={{marginVertical: 20, flexDirection: 'row'}}>
          ...
          <View
            ...
            <View style={{flexDirection: 'row', marginTop: 20}}>
              <View>
                <Text style={{color: '#64748B', fontSize: 14}}>15 Like</Text>
              </View>
              <View style={{marginLeft: '20%'}}>
                <Text style={{color: '#64748B', fontSize: 14}}>6 Replies</Text>
              </View>
            </View>
          </View>
        </View>

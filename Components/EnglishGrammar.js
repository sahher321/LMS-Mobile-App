        ...
        <ScrollView>
          ...
          <View
            ...
            <View style={{flexDirection: 'row', marginTop: '20%', padding: 13}}>
              <View style={{}}>
                <Text style={{fontSize: 16, fontWeight: 600, color: '#AE2327'}}>
                  English Grammar
                </Text>
                <Text style={{fontSize: 13, fontWeight: 400, color: '#07354B'}}>
                  Wren & Martin
                </Text>
              </View>
              <View>
            ...
            <View style={{padding: 13}}>
              <Text style={{fontSize: 14, color: '#07354B'}}>
                English grammar refers to the set of rules and principles that
                govern the structure and usage of the English language. It
                covers various aspects, including sentence structure, parts of
                speech, verb tenses, punctuation, and more
              </Text>
            </View>
            <View style={{padding: 13}}>
              <Text style={{fontSize: 14, color: '#07354B'}}>
            ...
            <TouchableOpacity>
              <View
                ...
                <View
                  ...
                  <View>
                    <Text
                      style={{fontSize: 15, color: '#FFFFFF', marginLeft: 10}}>
                      Start Exam
                    </Text>
                  </View>
                </View>
